      ...
      return (
        <div className="form-group row" key={reservation.reservation_id}>
          ...
          {reservation.status == "booked" ? (
              <div className="col-sm-1"><a className="btn" href={`/reservations/${reservation.reservation_id}/seat`}>seat</a></div>
              <div className="col-sm-1"><a className="btn" href={`/reservations/${reservation_id}/edit`}>edit</a></div>
          ) : ( "" )}
        </div>
      );
    })
